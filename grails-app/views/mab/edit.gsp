...
<div class="row">
    <div class="col-12">
        ...
        <h1><i class="fas fa-edit"></i> MAB bearbeiten</h1>
        ...
        <div class="card">
            <div class="card-body">
                <g:form resource="${mAB}" method="PUT" class="needs-validation" novalidate="true">
                    <g:hiddenField name="version" value="${mAB?.version}" />
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label for="hrComment" class="form-label">HR-Kommentar</label>
                                <g:textArea name="hrComment"
                                            value="${mAB?.hrComment}"
                                            rows="3"
                                            class="form-control"
                                            maxlength="1000" />
                    ...
                    <div class="mt-4">
                        ...
                        <g:link class="btn btn-outline-danger" action="delete" id="${mAB?.id}"
                                onclick="return confirm('Sind Sie sicher, dass Sie diese MAB löschen möchten?')">
